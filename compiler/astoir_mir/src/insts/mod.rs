...
pub enum MIRInstruction {
    ...
    // Constants
    IntegerSignedConstant {
        raw: i128,
        bitsize: usize,
    },
    IntegerUnsignedConstant {
        raw: u128,
        bitsize: usize,
    },
    FloatSignedConstant {
    ...
    StructInitializerConstant {
        struct_type: RawType,
        values: Vec<BaseMIRValue>,
    },
    ArrayInitializerConstant {
        values: Vec<BaseMIRValue>,
    },
    ArrayInitializerConstantSame {
        size: usize,
        val: BaseMIRValue,
    },
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::IntegerAdd {
                ...
                left,
                right,
            } => writeln!(f, "iadd s{} f{} {} {}", signed, fast, left, right)?,
            Self::IntegerSub {
                signed,
                fast,
                left,
                right,
            } => writeln!(f, "isub s{} f{} {} {}", signed, fast, left, right)?,
            Self::IntegerMul {
                signed,
                fast,
                left,
                right,
            } => writeln!(f, "imul s{} f{} {} {}", signed, fast, left, right)?,
            Self::IntegerDiv {
                signed,
                fast,
                left,
                right,
            } => writeln!(f, "idiv s{} f{} {} {}", signed, fast, left, right)?,
            Self::IntegerMod {
                signed,
                fast,
                left,
                right,
            } => writeln!(f, "imod s{} f{} {} {}", signed, fast, left, right)?,
            ...
            Self::FloatAdd {
                ...
                left,
                right,
            } => writeln!(f, "fadd s{} f{} {} {}", signed, fast, left, right)?,
            Self::FloatSub {
                signed,
                fast,
                left,
                right,
            } => writeln!(f, "fsub s{} f{} {} {}", signed, fast, left, right)?,
            Self::FloatMul {
                signed,
                fast,
                left,
                right,
            } => writeln!(f, "fmul s{} f{} {} {}", signed, fast, left, right)?,
            Self::FloatDiv {
                signed,
                fast,
                left,
                right,
            } => writeln!(f, "fdiv s{} f{} {} {}", signed, fast, left, right)?,
            Self::FloatMod {
                signed,
                fast,
                left,
                right,
            } => writeln!(f, "fmod s{} f{} {} {}", signed, fast, left, right)?,
            ...
            Self::IntegerSignedConstant { raw, bitsize } => {
                writeln!(f, "constints {} {}", raw, bitsize)?
            }
            Self::IntegerUnsignedConstant { raw, bitsize } => {
                writeln!(f, "constintu {} {}", raw, bitsize)?
            }
            ...
            Self::FixedSignedConstant {
                ...
                number,
                fraction,
            } => writeln!(f, "constffs {} {} {}", raw, number, fraction)?,
            Self::FixedUnsignedConstant {
                raw,
                number,
                fraction,
            } => writeln!(f, "constffu {} {} {}", raw, number, fraction)?,
            ...
            Self::ConditionalBranch {
                ...
                if_branch,
                else_branch,
            } => writeln!(f, "condbr {} {} {}", cond, if_branch, else_branch)?,
            ...
            Self::Select {
                ...
                if_val,
                else_val,
            } => writeln!(f, "select {} {} {}", cond, if_val, else_val)?,
