...
use astoir_mir::{
    ...
    builder::{
        build_bitwise_not, build_comp_eq, build_comp_ge, build_comp_gt, build_comp_le,
        build_comp_lt, build_comp_neg,
    },
    vals::int::MIRIntValue,
};
